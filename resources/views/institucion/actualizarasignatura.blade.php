...
<div class="container-fluid">
			...
			<form action="">
				...
				<div class="btn-group asi"><div class="btn-group"> <button type="button" class="btn btn-danger">  Asignaruta  </button><button type="button" class="btn btn-danger dropdown-toggle"data-toggle="dropdown"><span class="caret"></span></button></div>
				</div>
				<div class="input-group  inpu" style="text-align:center;">
				<label>Codigo</label>
