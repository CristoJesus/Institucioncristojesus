...
<body>
	<header class="row">
		...
		<div class="col-lg-2 cerrar"> <div class="col-lg-9"> <a href="{{url('/auth/logout')}}"><h4 class="letraslogin">Cerrar Sesion</h4> </div> <div class="col-lg-3"> <img class="imglogin" src="Images/login.png"  width="35" height="35"></a></div> </div>

	</header>

	<div class="container-fluid">
	<HR width=90% align="center"> 
		<p class="text-center">Secretaria</p>
			<HR width=90% align="center"> 
